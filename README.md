specified react-navigation version to 2.11.2  
router could use StackViewStyleInterpolator to navigate from horizontal on this version  

use by this:
```
yarn add git+https://github.com/NightFarmer/react-native-router-flux#has_stack_view_style
```
